...
## 1. `stage-udharpay-api-lb`

**Swimlane file:** `lb_audit_stage-udharpay-api-lb/swimlanes-lb-routing.txt`
...
| stage-users-and-verifications-tg | 80 | `/` | i-0b6dff3f3b61d1ef5 | 8081 | ✅ Healthy | ✅ |
| staging-account-preference | 80 | `/` | i-0973b4cfa3cad5f21 | 8086 | ✅ Healthy | ✅ |
| stage-payments-and-billing-tg | 80 | `/` | i-0b6dff3f3b61d1ef5 | 8082 | ✅ Healthy | ✅ |
| staging-udharpay-api-tg | 80 | `/` | i-0b6dff3f3b61d1ef5 | 8000 | ✅ Healthy | ✅ |
| staging-superkey-tg | 80 | `/superkey` | i-08d9bdc4a4fc5c313 | 8083 | ✅ Healthy | ✅ |
...
| stage-kyc-tg | 80 | `/` | i-041f841420f52438d | 8246 | ❌ FailedHealthChecks | ✅ |
...
**Swimlane file:** `stage-rpg-lb/swimlanes-lb-routing.txt`
...
## 3. `staging-udharpay-admin-lb`

**Swimlane file:** `staging-udharpay-admin-lb/swimlanes-lb-routing.txt`
